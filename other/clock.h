...
class CLOCK
{
	public:
		...
		u8 cutdown_string[10];//"dddhhmmss"。倒计时的字符串
	public:
		void begin();
		//每秒执行一次驱动时钟的运行
	...
	private:
	  ///////以下是日历计算的私有函数///////////////////////
		...
		void	mon_1_3_5_7_8_10_12_day_carry();//天的进位
		void	mon_4_6_9_11_day_carry();
		void	mon_2_day_carry();
		...
		u32		get_diff_sec(DATA_TIME_STRUCT &dt1,DATA_TIME_STRUCT &dt2);//两个时间之间的秒数差
